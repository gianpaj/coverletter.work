// https://github.com/huggingface/chat-ui/blob/f1da6444e93bc01aad454df8c381f3546ca5d9d1/src/lib/server/websearch/markdown/tree.ts
...
export function removeParents<T extends MarkdownElement>(elem: T): T {
  if ('children' in elem) {
    return {
      ...elem,
      parent: null,
      children: elem.children.map(child => removeParents(child)),
    };
  }
